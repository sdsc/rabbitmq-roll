# rabbitmq package README

This directoy contains the build files for the rabbitmq package, which is part
of the rabbitmq roll. Unique to the rabbitmq roll/package is the bundled 
